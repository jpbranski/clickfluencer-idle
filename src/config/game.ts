...
export const BALANCE = {
  ...
  GENERATOR_COST_MULTIPLIER: [
    ...
    1.12, // Collaboration
    1.11, // Brand Deal
    1.1, // Talent Agency (expensive, scales slow)
  ],
...
export const EVENT_DEFINITIONS: RandomEventDefinition[] = [
  ...
  },
  {
    ...
    name: "✨ Golden Hour",
    description:
      "Perfect lighting for content! 2.5x all production for 60 seconds",
    duration: 60000,
    weight: 7,
...
export function getNextMilestone(currentFollowers: number) {
  return (
    MILESTONES.find((m) => m.followers > currentFollowers) ||
