...
export const APP_INFO = {
  ...
  version: '0.1.0',
  description: 'Build your social media empire from a single click to becoming the ultimate digital influencer',
 ...
 */
export function setFeatureFlag(feature: keyof typeof FEATURES, enabled: boolean): void {
